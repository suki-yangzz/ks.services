...
import com.sssyayayiooo.ks.services.logging.bolt.AlarmBolt;
...
public class Runner {
    ...
    public Runner(@Value("${storm.brokerZkstr}") String brokerZkstr,
    ...
    public static void main(String[] args) {
        ...
        SpoutConfig spoutConfig = new SpoutConfig(brokerHosts, "api-log", "/storm", "s32");
